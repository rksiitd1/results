        ...
        >
          ...
          <div className="mb-6">
            ...
            <Select value={selectedClass} onValueChange={setSelectedClass}>
              <SelectTrigger className="w-full h-12 px-4 text-base border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                <SelectValue placeholder="Select your class" className="text-gray-900" />
              </SelectTrigger>
              <SelectContent className="bg-white rounded-xl shadow-lg border border-gray-100 py-2">
                {classes.map((cls) => (
                  <SelectItem 
                    key={cls.id} 
                    value={cls.id}
                    className="px-4 py-3 text-base hover:bg-gray-50 focus:bg-gray-50"
                  >
                    {cls.name}
                  </SelectItem>
                ))}
